...
public class RectMathTests
{
    ...
    public void DPI100では座標がそのまま変換される()
    {
        var result = RectMath.ToPhysicalRect(
            new DipRect(100, 50, 300, 200), Width100, Height100, Pixel100W, Pixel100H);

        Assert.Equal(new PixelRect(100, 50, 300, 200), result);
    }
    ...
    public void DPI150では1_5倍に変換される()
    {
        // 1920/1280 = 1.5 倍
        var result = RectMath.ToPhysicalRect(
            new DipRect(100, 50, 300, 200), Width150, Height150, Pixel100W, Pixel100H);

        // x=150, y=75, right=(400*1.5)=600, bottom=(250*1.5)=375
        Assert.Equal(new PixelRect(150, 75, 450, 300), result);
    }
    ...
    public void 端数座標は四捨五入される()
    {
        ...
        var result = RectMath.ToPhysicalRect(
            new DipRect(10.4, 10.4, 5.2, 5.2), Width150, Height150, Pixel100W, Pixel100H);
    ...
    public void 幅と高さは負にならない()
    {
        ...
        var result = RectMath.ToPhysicalRect(
            new DipRect(100, 100, 0, 0), Width100, Height100, Pixel100W, Pixel100H);
    ...
    public void ウィンドウサイズが0以下なら例外になる(double width, double height)
    {
        ...
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            RectMath.ToPhysicalRect(new DipRect(0, 0, 10, 10), width, height, Pixel100W, Pixel100H));
    }
    ...
    {
        Assert.Throws<ArgumentOutOfRangeException>(() =>
            RectMath.ClampToScreenshot(new PixelRect(0, 0, 10, 10), -1, Pixel100H));
    }

    [Fact]
    public void クランプは範囲内の矩形を変更しない()
    {
        var rect = new PixelRect(100, 100, 200, 200);
    ...
    public void 右下へはみ出した矩形は画像内に収まる()
    {
        var result = RectMath.ClampToScreenshot(
            new PixelRect(1800, 1000, 500, 500), Pixel100W, Pixel100H);

        Assert.Equal(new PixelRect(1800, 1000, 120, 80), result);
    }
    ...
    public void 左上へはみ出した矩形は原点側にクランプされる()
    {
        ...
        var result = RectMath.ClampToScreenshot(
            new PixelRect(-50, -50, 200, 200), Pixel100W, Pixel100H);

        Assert.Equal(new PixelRect(0, 0, 150, 150), result);
    }
    ...
    {
        var result = RectMath.ClampToScreenshot(
            new PixelRect(5000, 5000, 100, 100), Pixel100W, Pixel100H);
    ...
    {
        var result = RectMath.ClampToScreenshot(
            new PixelRect(-500, -500, 100, 100), Pixel100W, Pixel100H);
    ...
    public void 変換とクランプを通しても画像範囲内に収まる()
    {
        ...
        var physical = RectMath.ToPhysicalRect(
            new DipRect(0, 0, Width150, Height150), Width150, Height150, Pixel100W, Pixel100H);
